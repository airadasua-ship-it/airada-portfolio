...
cap.release()
row1 = np.hstack(thumbs[:11])
row2 = np.hstack(thumbs[11:])
cv2.imwrite('scratch/frames_174_195.jpg', np.vstack([row1, row2]))
print("Saved frames_174_195.jpg")
