...
cap.release()
row1 = np.hstack(thumbs[:8])
row2 = np.hstack(thumbs[8:])
cv2.imwrite('scratch/frames_160_175.jpg', np.vstack([row1, row2]))
print("Saved frames_160_175.jpg")
